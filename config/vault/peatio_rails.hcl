...
path "transit/encrypt/civicforge_engines_*" {
...
path "transit/encrypt/civicforge_wallets_*" {
  capabilities = ["create", "read", "update"]
}
# Encrypt beneficiaries data
path "transit/encrypt/civicforge_beneficiaries_*" {
  capabilities = [ "create", "read", "update" ]
}
# Decrypt beneficiaries data
path "transit/decrypt/civicforge_beneficiaries_*" {
  capabilities = [ "create", "read", "update" ]
}
# Renew tokens
